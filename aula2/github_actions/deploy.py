...
def create_stack(stack_name, template_body, **kwargs):
    cloudformation_client.create_stack(
        ...
        # capabilities deixa o iam criar recursos com nomes que ele quiser
    ...
    #waiter pode esperar por uma condicao.. no caso o stack_name ficar completo
...
#pegar caminho absoluto do arquivo yaml p evitar problema de caminho relativo
def _get_abs_path(path):
    return os.path.join(os.path.dirname(os.path.realpath(__file__)), path)


def create_or_update_stack():
    """ pega o arquivo yaml que cria o stack 
        verifica se ja existe ou não """
